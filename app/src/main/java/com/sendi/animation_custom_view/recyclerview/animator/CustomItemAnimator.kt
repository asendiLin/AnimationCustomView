package com.sendi.animation_custom_view.recyclerview.animator
...
class CustomItemAnimator : SimpleItemAnimator() {
    ...
    inner class MoveInfo constructor(var holder: RecyclerView.ViewHolder,
                                     var fromX: Int, var fromY: Int,
                                     var toX: Int, var toY: Int)

    inner class ChangeInfo private constructor(var oldHolder: RecyclerView.ViewHolder?,
        ...
        internal constructor(oldHolder: RecyclerView.ViewHolder,
...
//        animation.alpha(1f).setDuration(getAddDuration())
    ...
    fun animateMoveImpl(holder: RecyclerView.ViewHolder, fromX: Int, fromY: Int, toX: Int, toY: Int) {
        ...
        animation.setDuration(getMoveDuration()).setListener(object : AnimatorListenerAdapter() {
            override fun onAnimationStart(animator: Animator) {
...
//            oldViewAnim.alpha(0f)
        ...
        if (newView != null) {
            ...
            newViewAnimation
                    .translationX(0f)
                    .translationY(0f).setDuration(getChangeDuration())
                    .alpha(1f)
                    .setListener(object : AnimatorListenerAdapter() {
                        override fun onAnimationStart(animator: Animator) {
